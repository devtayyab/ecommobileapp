  ...
  return (
    <View style={{ paddingVertical: scale(50) }}>
      ...
      <View style={{ paddingVertical: scale(10) }}>
        <CustomInput containerStyle={{ backgroundColor: 'transparent' , fontFamily : 'serif' }} value={cardinfo?.cardname} label={String.cardName} onChangeText={(v)=>hanndleChange('cardname' , v)} />
      </View>
      <View style={{ paddingVertical: scale(10) }}>
        <CustomInput containerStyle={{ backgroundColor: 'transparent' , fontFamily : 'serif' }} value={cardinfo?.cardnumber} label={String.cardNo} onChangeText={(v)=>hanndleChange('cardnumber' , v)} IconRight={() => <Feather name="credit-card" color={appColors.primary} size={scale(20)} />} />
      </View>

      <View style={{ paddingVertical: scale(10) }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <CustomInput containerStyle={{ backgroundColor: 'transparent' , fontFamily : 'serif' }} value={cardinfo?.expirydate} label={String.expiry} onChangeText={(v)=>hanndleChange('expirydate' ,v)}/>
          <CustomInput containerStyle={{ backgroundColor: 'transparent' , fontFamily : 'serif' }} value={cardinfo?.cvv} onChangeText={(v)=>hanndleChange('cvv' ,v)} label={String.cvv} />
        </View>
      </View>
      ...
      <View style={{ paddingVertical: scale(10), flex: 1, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
        ...
        <View style={{ paddingLeft: scale(10) }}>
          <Label text={String.savCard} style={{ fontSize: scale(15) , fontFamily : 'serif' }} />
        </View>
      </View>
